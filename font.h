...
#define NUM_GLYPHS 102 // 96 ASCII 0x20..0x7F plus 6 ÄÖÜäöü
#define BYTES_PER_GLYPH 5
#define ROWS_PER_GLYPH 7
#define GLYPH_SPACING 2
static const uint8_t fontBytes[NUM_GLYPHS * BYTES_PER_GLYPH] = {
